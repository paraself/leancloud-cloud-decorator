...
exports.SetVerify = exports.GetVerifyParams = exports.VerifyParamsMissingUserOrMobilePhoneNumberError = exports.VerifyParamsMobileNumberUsedError = exports.InitVerify = void 0;
...
function token() {
    return new Promise((resolve, reject) => {
        (0, crypto_1.randomBytes)(16, function (err, buffer) {
            if (err) {
                reject(err);
            }
            else {
    ...
    if (params.type == "geetest") {
        ...
        if ("sms" in params) {
            ...
            if (!user && mobilePhoneNumber) {
                ...
                let phoneUser = await new leanengine_1.default.Query("_User")
